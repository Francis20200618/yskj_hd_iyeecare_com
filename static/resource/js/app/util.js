(function(window) {
	...
	util.image = function(val, callback,options, base64options ) {
		...
		require(['jquery', 'fileUploader'], function($, fileUploader){
            fileUploader.upload_url('./index.php?c=site&a=entry&m=yun_shop&do=shop&route=upload.upload.jsUpload&upload_type=');
			fileUploader.fetch_url('./index.php?c=site&a=entry&m=yun_shop&do=shop&route=upload.upload.fetch');
            fileUploader.image_url('./index.php?c=site&a=entry&m=yun_shop&do=shop&route=upload.upload.jsImage');
