...
class  Coupon extends BaseModel
{
     ...
     * @var array
     */
    protected $appends = ['coupon_type_name','get_time_scope'];

    public function getCouponTypeNameAttribute()
    {
        switch ($this->attributes['use_type']) {
...
//        'back_redpack','back_when','descnoset','deleted_at'];
    ...
    public function setGetTimeScopeAttribute($value){
        $this->attributes['get_start_time'] = isset($value[0]) ? $value[0] : 0 ;
        $this->attributes['get_end_time'] = isset($value[1]) ? $value[1] : 0;
    }

    public function getGetTimeScopeAttribute($value){
        return [$this->get_start_time == '0000-00-00 00:00:00' ? '' : $this->get_start_time, $this->get_end_time == '0000-00-00 00:00:00' ? '' : $this->get_end_time];
    }
}
