...
class PointLog extends BaseModel
{
    ...
    public function sourceComment()
    {
        return [
            ...
            PointService::POINT_MODE_CPS                                => "聚合CPS奖励",
            ...
            PointService::POINT_MODE_LOVE_WITHDRAW_FINAL_REDUCE         => '爱心值提现扣除(实际到账)',
            PointService::POINT_MODE_STORE_BALANCE_RECHARGE             => '门店余额充值奖励',
            PointService::POINT_MODE_MARKETING                          => PointService::POINT_MODE_MARKETING_ATTACHED,
            PointService::POINT_MODE_MARKETING_REFUND                   => PointService::POINT_MODE_MARKETING_REFUND_ATTACHED,
        ];
    }
