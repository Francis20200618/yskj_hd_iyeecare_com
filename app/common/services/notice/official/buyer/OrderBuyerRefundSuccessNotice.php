...
class OrderBuyerRefundSuccessNotice extends BaseMessageBody
{
    ...
    public function sendMessage()
    {
        ...
        $this->getTemplate('order_refund_success');
        $this->organizeData();
        \Log::debug("新版公众号消息-退款成功1",$this->template_id);
        \Log::debug("新版公众号消息-退款成功2",$this->fans->openid);
        \Log::debug("新版公众号消息-退款成功3",$this->data);
        //实际退费金额为0元，不发送模板消息
        if(bccomp($this->refund->price, '0.00', 2) === 0){
            return;
        }
