...
class PointService
{
    ...
    const POINT_MODE_MARKETING = 124;
    const POINT_MODE_MARKETING_ATTACHED = '营销活动赠送';

    const POINT_MODE_MARKETING_REFUND = 125;
    const POINT_MODE_MARKETING_REFUND_ATTACHED = '营销活动赠送退回';
    ...
    public function getModeAttribute($mode)
    {
        ...
        switch ($mode) {
            ...
            case(123):
                ...
                break;
            case(124):
                $mode_attribute = self::POINT_MODE_MARKETING_ATTACHED;
                break;
            case(125):
                $mode_attribute = self::POINT_MODE_MARKETING_REFUND_ATTACHED;
                break;
          }        
