...
class PointRefund
{
    ...
    public function refundReturn(AfterOrderRefundSuccessEvent $event)
    {
        ...
        $hasPointRefund = PointLog::where($where)->whereIn('order_goods_id', $order_goods_ids)->first();
        ...
        $pointLogs = PointLog::where($where)->whereIn('order_goods_id', $order_goods_ids)->get();
