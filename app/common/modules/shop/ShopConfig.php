            ...
            'shop-foundation' => [
                ...
                'goods-discount' => [
                    ...
                    [
                        'weight' => 2007,
                        'class' => function (\app\common\modules\orderGoods\models\PreOrderGoods $preOrderGoods) {
                            return new \app\frontend\modules\orderGoods\discount\GiftEnoughReduce($preOrderGoods);
                        },
                    ],
                    [
                        'weight' => 2010,
                ...
                'coupon' => [
                    ...
                    [
                        'key' => 'giftEnoughReduce',
                        'class' => function (\app\frontend\modules\order\models\PreOrder $preOrder) {
                            return new \app\frontend\modules\order\discount\GiftEnoughReduce($preOrder);
                        },
                    ],
                    [
                        'key' => 'gift',
                        'class' => function (\app\frontend\modules\order\models\PreOrder $preOrder) {
                            return new \app\frontend\modules\order\discount\GiftReduce($preOrder);
                        },
                    ],
                    [
                        'key' => 'giftPlus',
                        'class' => function (\app\frontend\modules\order\models\PreOrder $preOrder) {
                            return new \app\frontend\modules\order\discount\GiftPlusReduce($preOrder);
                        },
                    ],
                    [
