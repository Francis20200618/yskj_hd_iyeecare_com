...
trait PreOrderGoodsTrait
{
    ...
    public function getGiftPrice(){
        if (!$this->memberCart->is_gift) {
            ...
            return MarketingService::getGiftPriceByMemberCartInTrade($this->memberCart);
//            return MarketingService::getGiftPriceByGoodsId($this->goods->id, $this->order->uid, $this->memberCart->marketingService->marketing->id, $this->order->getRequest());
        }
    }
