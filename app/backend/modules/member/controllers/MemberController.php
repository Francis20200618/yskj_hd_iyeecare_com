...
class MemberController extends BaseController
{
    ...
    {
        $groups = MemberGroup::select('id', 'group_name')->where('uniacid', \YunShop::app()->uniacid)->get();
        $levels = MemberLevel::select(['id', 'level', 'level_name'])->uniacid()->get();
...
//        Member::updateMemberInfoById($mc, $uid);
    ...
    public function agentShow()
    {
        ...
        return $this->successJson('ok', [
            'member' => $member_info,
            'list' => (new FansItemService())->setAgentFansItem($list),
            'total' => $list['total'],
            'request' => $request,
        ]);
    }
