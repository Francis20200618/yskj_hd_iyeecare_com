...
class CommentController extends UploadVerificationBaseController
{
    ...
    public function saveSet()
    {
        ...
        if ($data) {
            ...
            $resData = [
                ...
                'goods_detail_praise_num' => $data['goods_detail_praise_num'],
    ...
    public function changeAuditStatus()
    {
        ...
        $commentModel->audit_operator = \YunShop::app()->username;
        $commentModel->audit_time = date('Y-m-d H:i:s');
...
//        exit;
        foreach ($list['data'] as &$item) {
            ...
            $item['images'] = $item['images'] ? collect(unserialize($item['images']))->map('yz_tomedia'): [];
