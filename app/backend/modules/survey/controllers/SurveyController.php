    ...
    private function getEntrance()
    {
        ...
        if (app('plugins')->isEnabled('min-app')) {
            ...
            if ($setting['switch'] and $setting['key'] and $setting['secret']) {
                ...
                if (!$mini_code = Cache::get('survey_mini_app_code')) {
                    ...
                    try {
                        ...
                        if ($response instanceof \EasyWeChat\Kernel\Http\StreamResponse) {
                            $file_path = '/storage/app/public/qr/home/';
                            $filename = $response->saveAs(base_path() . '/storage/app/public/qr/home', 'home_mini_code_' . \YunShop::app()->uniacid);
                        }
