    ...
    public function scopeOrders($query)
    {
        ...
        return $query->with([
            'hasManyOrderGoods'=> function($query){
                ...
                }])->select(['id','order_id','goods_id','goods_price','total','price','thumb','title','goods_option_id','goods_option_title','comment_status','comment_id','vip_price','payment_amount','deduction_amount']);
            },
            'hasOnePayType',
            'process',
...
//            var_dump($operationsSettings,$operations, $this->id);exit;
