...
class SingleEnoughReduce extends BaseDiscount
{
    ...
    protected function _getAmount()
    {
        ...
        $result = $this->order->orderGoods->exceptGift()->unique('goods_id')->sum(function (PreOrderGoods $orderGoods) {
    ...
    private function totalAmount(PreOrderGoods $orderGoods)
    {
        ...
        $amount = $this->order->orderGoods->exceptGift()->where('goods_id', $orderGoods->goods_id)->sum(function (PreOrderGoods $preOrderGoods) {
