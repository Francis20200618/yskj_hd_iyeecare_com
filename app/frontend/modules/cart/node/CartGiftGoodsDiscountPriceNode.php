...
class CartGiftGoodsDiscountPriceNode extends PriceNode
{
    private $discount;

    private $cartGoods;

    public function __construct(CartGiftGoods $cartGoods,BaseCartGiftDiscount $discount, $weight)
    {
    ...
    public function getPrice()
    {
        if ($this->cartGoods->isChecked()) {
            return bcsub($this->cartGoods->getPriceBefore($this->getKey()) , $this->discount->getAmount(), 2);
        } else {
