...
//        }
    ...
    public static function userData_v2($member_info, $yz_member)
    {
        ...
        $member_info['credit'] = [
            //增加是否显示余额值
            'is_show' => \Setting::get('shop.member.show_balance') ? 0 : 1,
            'text'    => \Setting::get('shop.shop.credit')?:'余额',
            'data'    => $member_info['credit2']
        ];
        ...
        $member_info['integral'] = [
            ...
            'text'    => \Setting::get('shop.shop.credit1')?:'积分',
            'data'    => $member_info['credit1']
        ];
        ...
        if (app('plugins')->isEnabled('love')) {
            ...
            $member_info['love_show']['unable_text'] = \Yunshop\Love\Common\Services\SetService::getLoveSet('unable_name') ?: '111白' . LOVE_NAME;
