                    ...
                    <div class="vue-main-form">
                        ...
                        <el-form-item label="是否可领取" prop="get_type">
                            ...
                            <div v-show="form.get_type == 1">
                                <el-form-item label="" prop="date_range">
                                    <span>领取时间： </span>
                                    <el-date-picker
                                            v-model="form.get_time_scope"
                                            type="datetimerange"
                                            range-separator="至"
...
{{--                                            @change="onDateRangeChange"--}}
                                    ...
                                    <div class="tip" v-show="form.get_type==1">未设置领取时间则不限制优惠券领取时间</div>
                                </el-form-item>
                        ...
                        <el-form-item label="是否在领券中心显示" prop="is_display">
                            <el-radio v-model="form.is_display" :label="0">可以</el-radio>
                            <el-radio v-model="form.is_display" :label="1">不可以</el-radio>
                        </el-form-item>
                    ...
                    this.$http.post(this.submit_url,{id:this.id}).then(function (response) {
                            if (response.data.result){
                                ...
                                if(this.id && response.data.data.coupon) {
                                    ...
                                    this.form.is_display = coupon.is_display;
                                    this.form.coupon_method = coupon.coupon_method;
                                    this.form.use_type = coupon.use_type;
                                    this.form.get_type = coupon.get_type;
                                    this.form.get_time_scope = coupon.get_time_scope;
                ...
                submitForm(formName) {
                    ...
                    let json = {
                        coupon:{
                            ...
                            get_time_scope:this.form.get_time_scope,
                    ...
                    //console.log(json['coupon']['is_display']);
                    if(this.form.use_type===9){
