            ...
            <div class="vue-main">
                ...
                <div class="vue-main-form">
                    <el-form-item label="显示库存" prop="is_show_stock">
                        <el-switch v-model="form.set.is_show_stock" :active-value="1" :inactive-value="0"></el-switch>
                        <div class="tip">开启后在自营，供应商，门店，聚合供应链，租赁商品详情页显示库存</div>
                    </el-form-item>
                </div>
                <div class="vue-main-form">
            ...
            submitForm(formName) {
                let json = {
                    data:{
                        ...
                        is_show_stock:this.form.set.is_show_stock,
