      ...
      <el-form :rules="rules" :model="form" label-width="130px">
        ...
        <el-form-item label="商品分类" required prop="category"  v-if="!attr_hide.hide_category">
          <el-row v-for="(categoryItem,itemIndex) in categoryList" style="margin-bottom:10px;" :key="itemIndex">
            ...
            <el-col :span="4" v-if="form.category_to_option_open==1">
        ...
        <el-form-item label="商品类型" v-if="form.goods.plugin_id != 140">
        ...
        <el-form-item label="下单是否需要地址" v-if="form.goods.type === 2">
        ...
        <el-form-item label="商品价格"  v-if="!attr_hide.hide_price">
          <el-row :gutter="10">
            <el-col :span="7">
              <el-input v-model="form.goods.price" :min="0" oninput="if(value<0)value=0" type="number">
                <template slot="prepend">现价</template>
                <template slot="append">元</template>
              </el-input>
            </el-col>
            <el-col :span="7">
              <el-input v-model="form.goods.market_price" :min="0" oninput="if(value<0)value=0" type="number">
                <template slot="prepend">原价</template>
                <template slot="append">元</template>
              </el-input>
            </el-col>
            <el-col :span="7">
              <el-input v-model="form.goods.cost_price" :min="0" oninput="if(value<0)value=0" type="number">
