            ...
            <el-form ref="form" :model="form" label-width="15%" :rules="rules">
                <div class="vue-head">
                    ...
                    <div class="vue-main-form">
                        ...
                        <el-form-item label="自定义显示评价条数" prop="goods_detail_praise_num">
                            <el-input v-model="form.goods_detail_praise_num" style="width:20%;"></el-input>
                            <div class="tip">请填写正整数，上限为20，默认是5。</div>
                        </el-form-item>
            ...
            data() {
                return{
                    ...
                    form:{
                        ...
                        is_score_latitude:'0',
                        top_sort:'asc',
                        goods_detail_praise_num:'5'
                    },
                    rules:{
                            goods_detail_praise_num:[
                                    {
            ...
            methods: {
                    ...
                    this.$http.post('{!! yzWebFullUrl('goods.comment.saveSet') !!}').then(function (response) {
                            if (response.data.result){
                                ...
                                if (that) {
                                    ...
                                    this.form.goods_detail_praise_num = that.goods_detail_praise_num ? that.goods_detail_praise_num : '5';
                                }
                            }
                            else {
                ...
                submitForm(formName) {
                    let json = {
                        ...
                        goods_detail_praise_num:this.form.goods_detail_praise_num
                    };
