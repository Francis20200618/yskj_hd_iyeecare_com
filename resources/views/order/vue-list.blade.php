        ...
        <div class="vue-head">
            ...
            <div class="vue-search">
                <el-form :inline="true" :model="search_form" class="demo-form-inline">
                    ...
                    <el-form-item label="">
                        <el-select v-model="search_form.sort" clearable placeholder="排序" style="width:150px">
                            <el-option label="会员排序" value="1"></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item label="">
                        {{--<el-switch v-model="search_form.first_order" active-text="搜索首单"--}}
                                   {{--inactive-text="不搜索首单" active-value="1" inactive-value="0"></el-switch>--}}
                    ...
                    <el-form-item label="">
                        <el-select v-model="search_form.order_status" multiple clearable placeholder="订单状态" style="width:150px">
                    ...
                    <el-form-item label="">
                        <el-select v-model="search_form.dispatch_type_id" clearable placeholder="配送方式" style="width:150px">
                    ...
                    @if(app('plugins')->isEnabled('marketing-qr'))
                        <el-form-item label="">
                            <el-input v-model="search_form.marketing_qr_label" placeholder="营销码标签"></el-input>
                        </el-form-item>
                    @endif
                    @if(app('plugins')->isEnabled('package-delivery'))
                        <el-form-item label="">
                            <el-input v-model="search_form.package_delivery_clerk_kwd" placeholder="平台核销员昵称/姓名/手机号"></el-input>
                        </el-form-item>
                        <el-form-item label="">
                            <el-input v-model="search_form.package_delivery_clerk_uid" placeholder="平台核销员会员ID"></el-input>
                        </el-form-item>
                    @endif
                    @if(app('plugins')->isEnabled('shop-clerk'))
                        <el-form-item label="">
                            <el-input v-model="search_form.shop_clerk_kwd" placeholder="pos收银员昵称/姓名/手机号"></el-input>
                        </el-form-item>
                        <el-form-item label="">
                            <el-input v-model="search_form.shop_clerk_uid" placeholder="pos收银员会员ID"></el-input>
                        </el-form-item>
                    @endif
                    <el-form-item label="">
                        <el-select v-model="search_form.time_field" clearable placeholder="不搜索时间" style="width:150px">
                ...
                <div v-for="(item,index) in list" style="border:1px solid #e9e9e9;border-radius:10px;margin-bottom:10px">
                    ...
                    <div class="list-con">
                        ...
                        <div class="list-con-member-info vue-ellipsis" style="min-width: 120px;">
                            <div style="min-width:75%;margin:0 auto">
                                ...
                                <div>订单商品总数量：[[item.order_goods_total]]</div>
                            </div>
                        </div>
                    ...
                    <div class="list-member">
                        <div>
                            ...
                            <template v-if="item.has_many_city_delivery_another&&item.has_many_city_delivery_another.length!=0">
...
<script>
    var app = new Vue({
        ...
        created() {
            ...
            this.times = [this.formatTime(new Date(new Date(new Date().toLocaleDateString()).getTime())),this.formatTime(new Date(new Date(new Date().toLocaleDateString()).getTime() + 1000 + 24 * 60 * 60 * 1000 - 1))]
        },
        mounted() {
            this.getData(1);
