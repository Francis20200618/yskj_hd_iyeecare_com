                        ...
                        <div class="">
                            <div class='input-group'>
                                ...
                                <input class="form-control" name="search[realname]" type="text"
                                       value="{{ $search['realname'] ?? ''}}" placeholder="会员ID／姓名／昵称／手机号">
                                    ...
                                    <select name="search[level_id]" class="form-control">
                                        ...
                                        @foreach($memberLevel as $level)
                                            <option value="{{ $level['id'] }}"
                                                    @if($search['level_id'] == $level['id']) selected @endif>{{ $level['level_name'] }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                    ...
                                    <select name="search[group_id]" class="form-control">
                                        ...
                                        @foreach($memberGroup as $group)
                                            <option value="{{ $group['id'] }}"
                                                    @if($search['group_id'] == $group['id']) selected @endif>{{ $group['group_name'] }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class='form-input'>
                                    ...
                                    <input class="form-control price" name="search[min_credit2]" type="text"
                                           value="{{ $search['min_credit2'] ?? ''}}" placeholder="最小">
                                    <p class="line">—</p>
                                    <input class="form-control price" name="search[max_credit2]" type="text"
                                           value="{{ $search['max_credit2'] ?? ''}}" placeholder="最大">
                                </div>
