                    ...
                    <div class="form-group col-sm-11 col-lg-11 col-xs-12">
                        <div class="">
                            <div class='input-group'>
                                <input class="form-control" name="search[queue_id]" type="text" value="{{ $search['queue_id'] ?? ''}}" placeholder="队列ID">
                                <input class="form-control" name="search[uid]" type="text" value="{{ $search['uid'] ?? ''}}" placeholder="会员ID">
                                <input class="form-control" name="search[member]" type="text" value="{{ $search['member'] ?? ''}}" placeholder="会员姓名／昵称／手机号">
                            </div>
                        </div>
                    </div>
