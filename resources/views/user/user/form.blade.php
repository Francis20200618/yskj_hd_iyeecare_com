    ...
    <script>
        var vm = new Vue({
            ...
            methods: {
                ...
                getData(){
                    this.$http.post('{!! yzWebFullUrl('user.user.store') !!}').then(function (response){
                        if (response.data.result) {
                ...
                submit() {
                    ...
                    this.$http.post('{!! yzWebFullUrl('user.user.store') !!}',{widgets:this.widgets,user:this.form,perms:this.arr}).then(function (response){
                        if (response.data.result) {
