...
@section('content')
    ...
    <div class="main rightlist">
        ...
        <form action="{{ yzWebUrl('finance.balance-set.store') }}" method="post" class="form-horizontal form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-xs-12">
                            ...
                            <label class='radio-inline'>
                                <input type='radio' name='balance[recharge]' value='1' @if($balance['recharge'] == 1) checked @endif/>
                                开启
                            </label>
                            <label class='radio-inline'>
                                <input type='radio' name='balance[recharge]' value='0' @if($balance['recharge'] == 0) checked @endif/>
                                关闭
                            </label>
                                            ...
                                            <label class='radio-inline'>
                                                <div class="input-group" style="width: 330px;">
                                                    ...
                                                    <input type="text" name="balance[recharge_activity_fetter]"
                                                           class="form-control"
                                                           value="{{ $balance['recharge_activity_fetter'] ?? -1 }}"
                                                           placeholder=""/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-xs-12">
                            ...
                            <label class='radio-inline'><input type='radio' name='balance[team_transfer]' value='0'
                                                               @if($balance['team_transfer'] ==0) checked @endif/>
                                关闭</label>
                            ...
                            <div class="col-sm-4 col-xs-12">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="balance[love_rate] " class="form-control"
                                           value="{{ $balance['love_rate']  ?? '0'}}" placeholder="0.00">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group recharge-item" style="margin-top:5px; width: 30%">
                        ...
                        <input type="text" class="form-control" name="balance[sms_hour_amount]"
                               value="{{ $balance['sms_hour_amount']  ?? '0'}}">
            ...
            <div>
                ...
                <div id="balance_deduct_set" class="form-group"
                     @if($balance['balance_deduct'] !=1 ) style="display:none" @endif >
            ...
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">充值余额赠送积分</label>
                <div class="col-sm-4 col-xs-6">
                    <label class="radio-inline">
                        <input type="radio" name="balance[charge_reward_swich]" value="1"
                               @if($balance['charge_reward_swich'] ==1 ) checked="checked" @endif>
                        开启
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="balance[charge_reward_swich]" value="0"
                               @if($balance['charge_reward_swich'] ==0 ) checked="checked" @endif >
                        关闭
                    </label>
                </div>
            </div>
            <div id="charge_reward_rate" @if($balance['charge_reward_swich'] !=1 ) style="display:none" @endif >
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label"></label>
                    <div class="col-sm-4 col-xs-12">
                        <div class="input-group">
                            <div class="input-group-addon">余额转换比例</div>
                            <input type="text" name="balance[charge_reward_rate] " class="form-control"
                                   value="{{ $balance['charge_reward_rate'] ?: '0'}}" placeholder="0.00">
                            <div class="input-group-addon">%</div>
                        </div>
                        <div class="help-block">
                            转化实例:实际赠送10积分,余额转化比例10%，则需要充值10 / 10%，比例为空或为0则默认为1:1
                        </div>
                    </div>
                </div>
            </div>
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">充值余额审核</label>
                <div class="col-sm-4 col-xs-6">
                    <label class="radio-inline">
                        <input type="radio" name="balance[charge_check_swich]" value="1"
                               @if($balance['charge_check_swich'] ==1 ) checked="checked" @endif>
                        开启
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="balance[charge_check_swich]" value="0"
                               @if($balance['charge_check_swich'] ==0 ) checked="checked" @endif >
                        关闭
                    </label>
                    <div class="help-block">
                        开启后，后台手动充值余额需要审核后才充值成功，与前端充值以及后台批量充值无关
                    </div>
                </div>
            </div>
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">收入提现赠送余额</label>
                <div class="col-sm-4 col-xs-6">
                    <label class="radio-inline">
                        <input type="radio" name="balance[income_withdraw_award]" value="1" @if($balance['income_withdraw_award'] == 1 ) checked="checked" @endif>
                        开启
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="balance[income_withdraw_award]" value="0" @if($balance['income_withdraw_award'] == 0 ) checked="checked" @endif >
                        关闭
                    </label>
                </div>
            </div>
            <div id="income_withdraw_award" @if($balance['income_withdraw_award'] !=1 ) style="display:none" @endif >
                <div class="form-group">
                    ...
                    <div class="col-sm-4 col-xs-12">
                        <div class="input-group">
                            <input type="text" name="balance[income_withdraw_award_rate] " class="form-control" value="{{ $balance['income_withdraw_award_rate'] ?: '0'}}" placeholder="0.00">
                            <div class="input-group-addon">%</div>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4 col-xs-12">
                        <div class="input-group">
                            <input type="text" name="balance[income_withdraw_wechat_rate] " class="form-control" value="{{ $balance['income_withdraw_wechat_rate'] ?: '0'}}" placeholder="0.00">
                            <div class="input-group-addon">%</div>
                        </div>
                        <div class="help-block"></div>
                    </div>
                ...
                @if(app('plugins')->isEnabled('high-light'))
                    <div class="form-group">
                        ...
                        <div class="col-sm-4 col-xs-12">
                            <div class="input-group">
                                <input type="text" name="balance[income_withdraw_light_rate] " class="form-control" value="{{ $balance['income_withdraw_light_rate'] ?: '0'}}" placeholder="0.00">
                                <div class="input-group-addon">%</div>
                            </div>
                            <div class="help-block"></div>
                        </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4 col-xs-12">
                    <textarea name="balance[income_withdraw_award_explain]" rows="5" class="form-control">{{ $balance['income_withdraw_award_explain'] }}</textarea>
                    <div class="help-block">收入提现页面提现成功自定义提示语，变量：[奖励余额]</div>
                </div>
            </div>
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label"></label>
    ...
    <script language='javascript'>
        ...
        $(function () {
            ...
            $(":radio[name='balance[income_withdraw_award]']").click(function () {
                if ($(this).val() == 1) {
                    $("#income_withdraw_award").show();
                } else {
                    $("#income_withdraw_award").hide();
                }
            });
            ...
            $(":radio[name='balance[charge_reward_swich]']").click(function () {

                if ($(this).val() == 1) {
                    $("#charge_reward_rate").show();
                } else {
                    $("#charge_reward_rate").hide();
                }
            });
