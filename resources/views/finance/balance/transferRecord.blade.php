                        ...
                        <div class="">
                            <div class='input-group'>
                                <input class="form-control" name="search[transfer]" type="text"
                                       value="{{ $search['transfer'] ?? ''}}" placeholder="转让者ID/昵称/姓名/手机号">
                                <input class="form-control" name="search[recipient]" type="text"
                                       value="{{ $search['recipient'] ?? ''}}" placeholder="被转让者ID/昵称/姓名/手机号">
                            </div>
                        </div>
                    </div>
            ...
            <div class="panel-body ">
                <table class="table table-hover">
                    ...
                    @foreach($tansferList as $list)
                        <tr>
                            <td>{{ $list->id }}</td>
                            <td>{{ $list->transferorInfo->realname ?? $list->transferorInfo->nickname }}({{ $list->transferor }})</td>
                            <td>{{ $list->recipientInfo->realname ?? $list->recipientInfo->nickname }}({{ $list->recipient }})</td>
                            <td>{{ $list->money }}</td>
