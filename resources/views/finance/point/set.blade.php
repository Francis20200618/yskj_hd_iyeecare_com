        ...
        <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data">
            <div class="panel panel-default">
                ...
                <div class='panel-body'>
                    ...
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">积分扣除</label>
                        <div class="col-sm-9 col-xs-12">
                            <label class="radio-inline">
                                <input type="radio" name="set[point_refund]" value='1'
                                       @if ($set['point_refund'] == 1) checked @endif /> 开启
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="set[point_refund]" value='0'
                                       @if (empty($set['point_refund'])) checked @endif /> 关闭
                            </label>
                    ...
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">积分仅支持抵扣整数</label>
                        <div class="col-sm-9 col-xs-12">
                            <label class="radio-inline">
                                <input type="radio" name="set[point_deduction_integer]" value='1'
                                       @if ($set['point_deduction_integer'] == 1) checked @endif /> 开启
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="set[point_deduction_integer]" value='0'
                                       @if (empty($set['point_deduction_integer'])) checked @endif /> 关闭
                            </label>
                            <span class='help-block'>开启后，积分抵扣只允许抵扣整数</span>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <div class='panel-body'>
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">前端显示</label>
                        <div class="col-sm-9 col-xs-12">
                            <label class="radio-inline">
                                <input type="checkbox" name="set[goods_point][search_page]" @if ($set['goods_point']['search_page'] == 'on') checked @endif />
                                <span>商品搜索页/分类页</span>
                            </label>
                            <label class="radio-inline">
                                <input type="checkbox" name="set[goods_point][goods_page]" @if ($set['goods_point']['goods_page'] == 'on') checked @endif />
                                <span>商品详情页</span>
                            </label>
                            <label class="radio-inline">
                                <input type="checkbox" name="set[goods_point][single_page]" @if ($set['goods_point']['single_page'] == 'on') checked @endif />
                                <span>下单页</span>
                            </label>
                            <label class="radio-inline">
                                <input type="checkbox" name="set[goods_point][order_page]" @if ($set['goods_point']['order_page'] == 'on') checked @endif />
                                <span>订单详情页</span>
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">数据显示</label>
                        <div class="col-sm-9 col-xs-12">
                            <label class="radio-inline">
                                <input type="radio" name="set[data_display_type]" value='0' @if (empty($set['data_display_type'])) checked @endif />
                                <span>赠送比例</span>
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="set[data_display_type]" value='1' @if ($set['data_display_type'] == 1) checked @endif />
                                <span>赠送数量</span>
                            </label>
                            <span class='help-block'>
                                赠送比例：商品设置的是百分比显示百分比，比如：设置3%，前端显示3%
                                <br>
                                赠送数量：商品设置的是百分比显示以商品现价*赠送比例显示
                            </span>
                        </div>
                    </div>
                    <div class="form-group">
