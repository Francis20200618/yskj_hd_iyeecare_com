            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-xs-12">
                            <div class="form-control-static">姓名: {{ $memberModel->realname ?? $memberModel->nickname }} / 手机号: {{ $memberModel->mobile }}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4 col-lg-3">
                            <div class='input-group' style="width: 260px;">
                                <input type="text" name="rate" value="{{ $memberModel->pointLove->rate ?? ''}}" class="form-control" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4 col-lg-2">
                            <div class='input-group recharge-item'>
                                <span class="input-group-addon"></span>
                                <input type="text" name="transfer_integral" value="{{ $memberModel->pointLove->transfer_integral ?? ''}}"
                                       class="form-control wid100"/>
                                <span class='input-group-addon'>:</span>
                                <input type="text" name="transfer_love" value="{{ $memberModel->pointLove->transfer_love ?? ''}}"
                                       class="form-control wid100"/>
                            </div>
